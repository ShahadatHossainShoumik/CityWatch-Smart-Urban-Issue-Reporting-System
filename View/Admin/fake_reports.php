        ...
        <div class="search-container">
            <form action="fake_reports.php" class="search-form" method="GET">
                ...
                <select name="filter" onchange="this.form.submit()" style="padding: 10px; border-radius: 3px;">
                    ...
                    <option value="active" <?php echo ($filterStatus === 'active') ? 'selected' : ''; ?>>Active Users
                    </option>
                    <option value="blocked" <?php echo ($filterStatus === 'blocked') ? 'selected' : ''; ?>>Blocked Users
                    </option>
                </select>
                                ...
                                <?php if ($user['is_blocked'] == 1): ?>
                                    <form action="../../Controller/AdminController.php" method="POST" style="display:inline;">
                                        ...
                                        <button type="submit" class="btn btn-unblock"
                                            style="padding: 8px 12px; background-color: #4CAF50; color: white; border: none; border-radius: 3px; cursor: pointer;">Unblock</button>
                                    </form>
                                <?php else: ?>
                                    <form action="../../Controller/AdminController.php" method="POST" style="display:inline;"
                                        ...
                                        <button type="submit" class="btn btn-block"
                                            style="padding: 8px 12px; background-color: #f44336; color: white; border: none; border-radius: 3px; cursor: pointer;">Block</button>
                                    </form>
                                <?php endif; ?>
                            </td>
                        </tr>

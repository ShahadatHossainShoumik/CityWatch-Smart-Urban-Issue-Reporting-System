...
<body>
    ...
    <div class="content">
        ...
        <?php if ($admin): ?>
            <form action="../../Controller/AdminController.php" method="POST" class="update-admin-form"
                ...
                <input type="text" id="mobile" name="mobile" value="<?php echo htmlspecialchars($admin['mobile'] ?? ''); ?>"
                    style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 3px;">

                <label for="dob">Date of Birth:</label>
                <input type="date" id="dob" name="dob" value="<?php echo htmlspecialchars($admin['dob'] ?? ''); ?>"
                    style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 3px;">

                <label for="nid">NID (National ID):</label>
                <input type="text" id="nid" name="nid" value="<?php echo htmlspecialchars($admin['nid'] ?? ''); ?>"
                    style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 3px;">

                <label for="role">Role:</label>
                <input type="text" id="role" name="role" value="<?php echo htmlspecialchars($admin['role']); ?>" disabled

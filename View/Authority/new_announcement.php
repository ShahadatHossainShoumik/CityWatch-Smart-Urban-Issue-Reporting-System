    ...
    <div class="content">
        ...
        <form action="#" method="POST" class="announcement-form">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" placeholder="e.g., Damage Road" required>
            </div>

            <div class="form-group">
                <label for="description">Description</label>
                <textarea id="description" name="description" rows="5" placeholder="Enter full details here..." required></textarea>
            </div>

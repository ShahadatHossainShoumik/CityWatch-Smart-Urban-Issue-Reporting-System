...
<body>
    ...
    <div class="content">
        ...
        <div class="form-card">
            ...
            <form class="incident-form" action="../../Controller/IssueController.php" method="POST"
                enctype="multipart/form-data">

                <div class="form-group">
                    <label for="title">Incident Title</label>
                    <input type="text" id="title" name="title" placeholder="Enter a short title (e.g., Damaged Road)"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="5" placeholder="Describe what happened..."
                        required></textarea>
                </div>

...
<body>
    ...
    <div class="content">
        ...
        <?php if ($announcement): ?>
            <form action="../../Controller/AdminController.php" method="POST" class="update-announcement-form"
                ...
                <textarea id="message" name="message" rows="5" required
                    style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 3px; font-family: Arial, sans-serif;"><?php echo htmlspecialchars($announcement['message']); ?></textarea>
